...
def load_config(config_path="config.ini"):
    ...
    return {
        ...
        "prompt_template": config.get("Prompt", "template",fallback='Return following text extracted from a PDF as structured JSON.\nText:\n{text}'),
        "activeVerification": config.get("Verification", "active", fallback="False"),
